...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_ALTGR] = LAYOUT(
        ...
        KC_LSFT, KC_NO,      KC_NO,      KC_NO,      KC_NO,      RALT(KC_7), KC_NO,      KC_NO, RALT(KC_0), KC_NO,         KC_NO,      KC_NO,      KC_NO,      KC_RSFT,
                                                           KC_LCTL, KC_LALT, KC_TRNS,      KC_ENT, KC_RALT, KC_RCTL
        ),
	[_FUNCTIONS] = LAYOUT(
        ...
        RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_MUTE, KC_VOLU,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,  KC_NO,
        RGB_TOG, RGB_HUD, RGB_SAD, RGB_VAD, KC_NO,   KC_VOLD, KC_NO,      KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_RSFT,
                                           KC_LCTL,   KC_LALT, KC_NO,     KC_NO, KC_TRNS, KC_DEL
        )
};
