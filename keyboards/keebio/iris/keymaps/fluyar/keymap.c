...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_ALNUM] = LAYOUT(
        KC_ESC,        DE_1, DE_2, DE_3, DE_4, DE_5,                        DE_6, DE_7, DE_8,    DE_9,   DE_0,   KC_RGUI,
        KC_TAB,        DE_Q, DE_W, DE_E, DE_R, DE_T,                        DE_Z, DE_U, DE_I,    DE_O,   DE_P,    DE_PLUS,
        KC_LCTRL,      DE_A, DE_S, DE_D, DE_F, DE_G,                        DE_H, DE_J, DE_K,    DE_L,   DE_LABK, DE_CIRC,
        OSM(MOD_LSFT), DE_Y, DE_X, DE_C, DE_V, DE_B, KC_MUTE,      KC_MPLY, DE_N, DE_M, DE_COMM, DE_DOT, DE_MINS, OSM(MOD_RSFT),
                                   KC_LGUI,    KC_LALT, MO(_ALTGRMOD),      KC_SPC, MO(_FNMOD), KC_BSPC
        ),
	[_ALTGRMOD] = LAYOUT(
        KC_NO,   S(DE_SS),      ALGR(DE_2), ALGR(DE_3), KC_NO,   KC_NO,                     KC_NO,   ALGR(DE_7), ALGR(DE_8), ALGR(DE_9), ALGR(DE_0),   KC_RGUI,
  ...
  [_FNMOD] = LAYOUT(
        KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10, KC_RGUI,
        KC_NO,   KC_F11,  KC_F12,  KC_NO, KC_NO, KC_NO,                    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_PSCR,  KC_SLCK,
        KC_LCTRL, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO, RGB_MOD,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_UP,  KC_PAUS,
        KC_LSFT, RGB_HUD, RGB_SAD, RGB_VAD, KC_NO,   RGB_TOG, KC_NO,      KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_LEFT,   KC_DOWN,  KC_RGHT,
                                           KC_LGUI, KC_LALT, KC_TRNS,     KC_ENT, KC_TRNS, KC_DEL
        ),
};
